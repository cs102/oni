...
// Add 90 procedural placeholders
const morePrefixes = [
  ...
  "coir","counter","ob","of","op","pri","tele","geo","chrono","thermo",
...
nodes.forEach((n, i) => {
  ...
  if (i % 7 === 0) links.push({ source: i, target: (i + 13) % nodes.length }); // random long jumps
});
...
const node = svg.append("g")
  ...
  .style("cursor", "grab")
  .text(d => d.prefix)
  .call(drag)           // ← makes nodes draggable
